    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('invoicesReports.Search_customers') }}" method="POST" role="search" autocomplete="off">
                    @csrf
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="{{ route('invoicesDetails.show', $invoice->id) }}">{{ $invoice->section->section_name }}</a>
                                        </td>
