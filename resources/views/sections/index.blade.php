                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                ...
                                                href="#exampleModal{{ $section->id }}" title="تعديل"><i
                                                    class="las la-pen"></i></a>
                                                   
                                                    @endcan

                                            <!-- edit -->
                                            <div class="modal fade" id="exampleModal{{ $section->id }}" tabindex="-1"
                                            ...
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                data-toggle="modal" href="#modaldemoexampleModal{{ $section->id }}"
                                                title="حذف"><i class="las la-trash"></i></a>
                                                @endcan

                                            <div class="modal" id="modaldemoexampleModal{{ $section->id }}">
                                                    ...
                                                    <div class="modal-content modal-content-demo">
                                                        ...
                                                        <form action="{{ route('sections.destroy', $section->id) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p>القسم الذي سوف يحذف هو : <span
                                                                        style="font-size: 22px; color: red">
                                                                        {{ $section->section_name }}</span></p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="section_name"
                                    id="exampleFormControlInput1" placeholder="اسم القسم">
