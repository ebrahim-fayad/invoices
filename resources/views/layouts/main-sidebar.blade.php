			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/me_3.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category" style="font: 25px italic; color:red; margin-bottom: 30px ">برنامج الفواتير</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@if (allInvoices()->count() <= 0)
									<span class="text-warnning p-3" >لاتوجد اي نوع من الفواتير</س>

							@else
							<form action="{{ route('invoices.invoicesStatus') }}" method="post">
								
								@csrf
								@can('الفواتير المدفوعة')
										
								<li><button class="btn slide-item" type="submit" value="1" name="Value_Status" class="slide-item" >الفواتير المدفوعة</button></li>
								@endcan
								@can('الفواتير الغير مدفوعة')
										
								<li><button class="btn slide-item" type="submit" value="2" name="Value_Status" class="slide-item" >الفواتير الغير مدفوعة</button></li>
								@endcan
								@can('الفواتير المدفوعة جزئيا')
										
								<li><button class="btn slide-item" type="submit" value="3" name="Value_Status" class="slide-item" >الفواتير المدفوعة جزئيا</button></li>
								@endcan
							</form>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							 @can('تقرير الفواتير')
							<li><a class="slide-item" href="{{ route('invoicesReports.index') }}">تقارير الفواتير</a></li>
							@endcan
							 @can('تقرير العملاء')
							<li><a class="slide-item" href="{{ route('invoicesReports.customer') }}">تقارير العملاء</a></li>
							@endcan
					...
					@endcan
					 ...
					 <li class="slide">
						...
						@endcan
						 @can('الاعدادات')
					<li class="side-item side-item-category" style="font-size: 22px">الاعدادات</li>
					<li class="slide" >
						...
						<ul class="slide-menu" >
							 @can('الاقسام')
							<li><a class="slide-item"style="font-size: 18px" href="{{ route('sections.index') }}">اضافة قسم</a></li>
							@endcan
							@can('المنتجات')
							<li><a class="slide-item"style="font-size: 18px" href="{{ route('products.index') }}">اضافة منتج</a></li>
							@endcan
						</ul>
					</li>
