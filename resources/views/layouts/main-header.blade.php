					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									...
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											<div class="  drop-img  cover-image  " data-image-src="{{URL::asset('assets/img/faces/me_3.jpg')}}">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
												<a href="{{ route('markAll') }}" style="color: black">
									...
									<div class="main-notification-list Notification-scroll">
												...
												<div id="unreadNotifications">
													...
													<a class="d-flex p-3 border-bottom" href="{{ route('invoicesDetails.show', $i->data['invoice_id']) }}">
														<div class="notifyimg bg-pink">
															<i class="la la-file-alt text-white"></i>
														</div>
														
														<div class="mr-3">
															<h5 class="notification-label mb-1">{{ $i->data['title'] }}
																																	{{ $i->data['user'] }}
																															</h5>
															<div class="notification-subtext">{{ $i->created_at->diffForHumans()}}</div>
														</div>
														<div class="mr-auto" >
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/me_3.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/me_3.jpg')}}" class=""></div>
